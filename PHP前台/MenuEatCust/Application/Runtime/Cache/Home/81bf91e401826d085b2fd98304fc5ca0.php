...
<section class="Psection MT20">
    ...
    <article class="U-article Overflow">
        <section class="M-coupon Overflow">
            ...
            <ul>
                <?php if(is_array($dataCfc)): $i = 0; $__LIST__ = $dataCfc;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$i): $mod = ($i % 2 );++$i;?><a href="shop.html" class="Fontfff" target="_blank">
                        <li>
                            <p class="U-price FontW"><i>￥</i><?php echo ($i["cfc_money"]); ?><span class="Font14 FontW"><?php echo ($i["cfc_food"]); ?></span></p>
                            <p>发行店铺：<?php echo ($i["cfc_name"]); ?></p>
                            <p>有效期：<?php echo ($i["cfc_start_time"]); ?>至<?php echo ($i["cfc_end_time"]); ?></p>
                        </li>
